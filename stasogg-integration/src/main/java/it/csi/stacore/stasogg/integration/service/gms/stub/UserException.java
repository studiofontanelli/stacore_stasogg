...
public class UserException  extends it.csi.stacore.stasogg.integration.service.gms.stub.CSIException  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:gmsregsrv", "UserException"));
    }
