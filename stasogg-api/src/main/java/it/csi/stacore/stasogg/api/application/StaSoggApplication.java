package it.csi.stacore.stasogg.api.application;
...
import it.csi.stacore.stasogg.api.interceptor.LoggingInterceptor;
import it.csi.stacore.stasogg.api.provider.ExceptionHandler;
import it.csi.stacore.stasogg.util.ApplicationContextManager;
...
@ApplicationPath("/api")
public class StaSoggApplication extends Application {
