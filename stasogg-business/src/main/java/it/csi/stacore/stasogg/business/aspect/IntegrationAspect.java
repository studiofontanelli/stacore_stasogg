...
public class IntegrationAspect extends CommonAspect {
	...
	@Around(value = "execution(* it.csi.stacore.stasogg.integration.service.impl..*.*(..))", argNames = "joinPoint")
	...
	@AfterThrowing (pointcut="execution(* it.csi.stacore.stasogg.integration.service.impl..*.*(..))", throwing="ex" )
